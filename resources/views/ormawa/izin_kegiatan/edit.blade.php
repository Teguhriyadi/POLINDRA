                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group @error("tempat_pelaksanaan") {{ 'has-error' }}@enderror">
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="form-control" name="tempat_pelaksanaan" id="tempat_pelaksanaan" placeholder="Masukkan Tempat Pelaksanaan" value="{{ old('tempat_pelaksanaan') ?? $edit->tempat_pelaksanaan ?? '' }}">
